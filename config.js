...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '263715275611'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'Tilzly ofc',
  packname:  process.env.PACK_NAME || 'Modified BY Tilzly ofc',
