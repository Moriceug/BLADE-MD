...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '256761565724'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
global.sudo = process.env.SUDO || "256761565724"
...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'MORICE BOT',
  packname:  process.env.PACK_NAME || 'MADE BY MORICE',
  
  botname:   process.env.BOT_NAME === undefined ? "MORICE-MD" : process.env.BOT_NAME,
